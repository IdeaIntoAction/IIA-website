...
<template>
  <div>
    <table
      class="table-auto m-auto border-separate border-spacing-2 border border-slate-400"
    >
      <caption class="caption-top mb-2 mt-2 text-center font-extrabold">
        Parser List
      </caption>
      <thead>
        <tr>
        ...
        <tr>
          <th class="text-center">
            <input
              class="h-12 px-1 border border-slate-700 font-normal"
              type="text"
            />
          </th>
          <th class="text-center">
          ...
          <th class="text-center w-10 h-10">
            <input v-model="filterConditions.act" type="checkbox" />
          </th>
          <th class="text-center">
            <input
              class="h-12 px-1 border border-slate-700 font-normal"
          ...
          <th class="text-center w-10 h-10">
            <input v-model="filterConditions.stop" type="checkbox" />
          </th>
          <th class="text-center w-10 h-10">
            <input v-model="filterConditions.work" type="checkbox" />
          </th>
        </tr>
      </thead>
